...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Environment related activities</title>
          ...
          <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="courseArchive_content">              
             ...
             <div class="single_course_content">
               <h2>Our activities on environment</h2>
               
               <p>
			   
			   Bangladesh, with an area of 144,000 km2, features a flood plain landscape and several river systems throughout the country. This landscape provides the major natural resources of water, land, fisheries, forests, and wildlife.[1] The country currently faces several environmental issues which threaten these resources, including groundwater metal contamination, increased groundwater salinity, cyclones and flooding, and sedimentation and changing patterns of stream flow due to watershed mismanagement. Some of these, such as the changing patterns of stream flow and presence of lead in groundwater, can be directly correlated with human activity and industrial processes, while others, such as cyclones and flooding are naturally occurring issues. Many of these issues are further exacerbated by climate change, which causes increased occurrence of storms and cyclones and rising sea levels. According to the Notre Dame Global Adaptation Index, Bangladesh is the 43rd most vulnerable country to the effects of climate change, and the 37th least prepared country to address these effects.[2] There has been some government actions taken to address these issues.Isabela foundation is working on these.</p>
             </div>
